import { PencilIcon, useClickOutside } from '@kaizen/core-client';
...
export const Category = ({
  ...
  return (
    <div className="relative">
      <div className="category inline-flex flex-row items-center justify-center gap-x-1">
        <button
      ...
      <div
        ref={dropdownRef}
        tabIndex={-1}
        className={`${showDropdown ? 'flex flex-col gap-y-1' : 'hidden'} absolute left-0 top-full z-10 mt-1 w-64 rounded-lg border bg-white p-2 shadow-xl`}>
        <input
          value={searchText}

...
export const Modal = ({ isOpen, children, onCloseModal }: ModalProps) => {
  return isOpen ? (
    <div className="fixed bottom-0 left-0 right-0 top-0 flex items-center justify-center">
      ...
      <div
        className={`bg-neutral-0 fixed bottom-0 z-10 h-[90%] w-full overflow-y-auto rounded-xl shadow-md md:relative md:bottom-auto md:h-auto md:max-w-lg md:rounded-md`}>

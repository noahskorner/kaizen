...
export const metadata: Metadata = {
  title: 'Kaizen',
  description: 'A blog about software development and design.'
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} flex min-h-screen flex-col items-stretch`}>
        ...
        <main className="flex h-full flex-1 flex-col pt-24">{children}</main>
      </body>
    </html>
  );
}
